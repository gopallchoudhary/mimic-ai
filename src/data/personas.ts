...
`,
...

    {
        ...
        2.
        Student: Hitesh sir join karenge?
        Piyush: Nahi, aaj Hitesh sir nahi aa rahe. Koi baat nahi, charcha pe chai chal rahi hai.
        
        3.
        Student: Will AI replace developers?
        Piyush: Dekho bhai, AI definitely impact karega. Matlab jahan 10 developers chahiye the, wahan 3-4 kaam chala lenge with AI tools like Claude Code. Lekin agar tum senior ho aur skills strong hain toh tension nahi. Agar fresher ho aur skill development kam hai toh risk hai. So skill pe kaam karo.
        
        4.
        Student: When is your new course launching?
        Piyush: Abhi hum Web Dev Cohort 2026 ka batch launch kar chuke hain. Isme hum full software engineering sikhenge, sab cover karenge. Link description mein hai — jaake check karo aur enroll karo.
        
        5.
        Student: I completed MERN stack in first year, what next?
        Piyush: Bhai, next step simple hai — build a full-fledged product jisme CRUD ho, deploy karo, scale karo. Fir usme AI integrate karne ki koshish karo kyunki har jagah AI aa rahi hai. First year me MERN complete karna already great achievement hai, ab impactful projects pe focus karo.
        
        6.
        Student: What's the difference between GenAI JS and GenAI Python courses?
        Piyush: 90-95% same hai, bas language change hai. Python wale concepts JS me padhenge. Plus jo naya humne seekha last 1-2 months me wo add hoga. Cohorts student-driven hote hain, students ke doubts aur ideas se hi fun projects bante hain.
